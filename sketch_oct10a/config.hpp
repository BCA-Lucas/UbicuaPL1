...
extern const int DHTPIN;      // DHT11 (1)
extern const int PIN_LLU_D;   // YL-83 Lluvia Digital (3)
extern const int PIN_LLU_A;   // YL-83 Lluvia Analógica (18)
extern const int PIN_SON_A;   // KY-037 Sonido Analógico (19)
extern const int PIN_SON_D;   // KY-037 Sonido Digital (3)
extern const int PIN_UV_A;    // ML8511 UV Analógico (34)
extern const int PIN_LED_RUIDO; // LED de Ruido (2)
